...
//                     data = await apiService.getSmokeFreeDaysRanking(topN);
//                     break;
//                 case 'cigarettes-dropped':
//                     data = await apiService.getCigarettesDroppedRanking(topN);
//                     break;
//                 case 'achievements':
//                     data = await apiService.getAchievementsRanking(topN);
//                     break;
//                 case 'challenges':
//                     data = await apiService.getChallengesCompletedRanking(topN);
//                     break;
//                 default:
//                     throw new Error('❌ Không có API liên quan cho loại bảng xếp hạng này!');
//             }

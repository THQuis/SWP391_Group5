...
const CoachMembers = () => {
    ...
    const handleClickMember = (member) => {
        ...
        apiFetch(`/api/coach/user/${member.UserID}/progress`, {
            method: "GET",
            headers: {
                "accept": "*/*",
                "Authorization": `Bearer ${token}`,
    ...
    const handleViewChallenges = (member) => {
        ...
        const token = localStorage.getItem("userToken");
        apiFetch(`/api/coach/user/${member.UserID}/challenges`, {
            method: "GET",
            headers: {
                "accept": "*/*",
                "Authorization": `Bearer ${token}`,
    ...
    return (
        <Container style={{ marginTop: 40, marginBottom: 40 }}>
            <h2 className="fw-bold mb-4">Danh sách thành viên đang đồng hành</h2>
            {loading ? (
                <div className="text-center my-5">
                    <Spinner animation="border" />
                </div>
